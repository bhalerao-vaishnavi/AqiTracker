...
def get_aqi(city):
    ...
    if (aqi < 50):
        ...
        condition.place(x = 150 , y= 500 , width=450 , height=50)
        ...
        condition.place(x = 150 , y= 500 , width=150 , height=50)


cond =tk.Label(root,text="Entry a Place",bg = "light blue" ,font=('times new roman',20,BOLD),width = 40)
cond.place(x = 5 , y= 50 , height= 50 )

textbox1 = tk.Entry(root,font=('times new roman',20),width=40)
textbox1.place(x = 150 , y=150 , width=300 , height=60)

button1 = tk.Button(root,text='AQI',fg='blue',font=('times new roman',18),width=8,command=lambda: get_aqi(textbox1.get()))
button1.place(x = 150 , y= 250 , width=200 , height=60)

air_label=tk.Label(root,text="",font=('times new roman',18),width=40)
air_label.place(x = 150 , y= 350 , width=150 , height=50)
